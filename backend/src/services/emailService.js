...
class EmailService {
  ...
  async sendToVisitor(name, email) {
    ...
    try {
          ...
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 10px;">
            <div style="background: white; padding: 30px; border-radius: 8px;">
              ...
              <ul style="color: #555; line-height: 1.8;">
                <li>Check out my <a href="https://github.com/devarshi07" style="color: #667eea;">GitHub</a> for my latest projects</li>
      ...
      console.error('❌ Error sending visitor email:', error.response?.body || error);
      throw error;
    }
  }
  ...
  async sendToOwner(name, email, message, metadata) {
    ...
    try {
      ...
      console.error('❌ Error sending owner email:', error.response?.body || error);
      throw error;
    }
  }
}
